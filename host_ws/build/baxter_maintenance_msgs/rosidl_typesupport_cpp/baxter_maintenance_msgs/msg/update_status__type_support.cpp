...
static const _UpdateStatus_type_support_symbol_names_t _UpdateStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, baxter_maintenance_msgs, msg, UpdateStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, baxter_maintenance_msgs, msg, UpdateStatus)),
  }
};
...
{
  return &::baxter_maintenance_msgs::msg::rosidl_typesupport_cpp::UpdateStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, baxter_maintenance_msgs, msg, UpdateStatus)() {
  return get_message_type_support_handle<baxter_maintenance_msgs::msg::UpdateStatus>();
}
