...
#include "baxter_maintenance_msgs/msg/detail/update_source__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // devname, filename, uuid, version
#include "rosidl_runtime_c/string_functions.h"  // devname, filename, uuid, version

// forward declare type support functions


using _UpdateSource__ros_msg_type = baxter_maintenance_msgs__msg__UpdateSource;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: devname
  {
    const rosidl_runtime_c__String * str = &ros_message->devname;
  ...
  baxter_maintenance_msgs__msg__UpdateSource * ros_message)
{
  // Field name: devname
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->devname.data) {
      rosidl_runtime_c__String__init(&ros_message->devname);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->devname,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'devname'\n");
      return false;
    }
  }
...
{
  const _UpdateSource__ros_msg_type * ros_message = static_cast<const _UpdateSource__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_maintenance_msgs__msg__UpdateSource;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_maintenance_msgs__msg__UpdateSource * ros_message = static_cast<const baxter_maintenance_msgs__msg__UpdateSource *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_maintenance_msgs__msg__UpdateSource(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_maintenance_msgs__msg__UpdateSource * ros_message = static_cast<baxter_maintenance_msgs__msg__UpdateSource *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_maintenance_msgs__msg__UpdateSource(cdr, ros_message);
}

static uint32_t _UpdateSource__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_baxter_maintenance_msgs__msg__UpdateSource(
...
static size_t _UpdateSource__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_baxter_maintenance_msgs__msg__UpdateSource(
...
static message_type_support_callbacks_t __callbacks_UpdateSource = {
...
static rosidl_message_type_support_t _UpdateSource__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UpdateSource,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, baxter_maintenance_msgs, msg, UpdateSource)() {
  return &_UpdateSource__type_support;
}
