...
bool cdr_serialize_baxter_maintenance_msgs__msg__UpdateStatus(
  const baxter_maintenance_msgs__msg__UpdateStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_maintenance_msgs
bool cdr_deserialize_baxter_maintenance_msgs__msg__UpdateStatus(
  eprosima::fastcdr::Cdr & cdr,
  baxter_maintenance_msgs__msg__UpdateStatus * ros_message)
{
  // Field name: status
  {
    cdr >> ros_message->status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_maintenance_msgs__msg__UpdateStatus;
    is_plain =
      (
      offsetof(DataType, long_description) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_maintenance_msgs
bool cdr_serialize_key_baxter_maintenance_msgs__msg__UpdateStatus(
  const baxter_maintenance_msgs__msg__UpdateStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_maintenance_msgs
size_t get_serialized_size_key_baxter_maintenance_msgs__msg__UpdateStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UpdateStatus__ros_msg_type * ros_message = static_cast<const _UpdateStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_maintenance_msgs
size_t max_serialized_size_key_baxter_maintenance_msgs__msg__UpdateStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_maintenance_msgs__msg__UpdateStatus * ros_message = static_cast<const baxter_maintenance_msgs__msg__UpdateStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_maintenance_msgs__msg__UpdateStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_maintenance_msgs__msg__UpdateStatus * ros_message = static_cast<baxter_maintenance_msgs__msg__UpdateStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_maintenance_msgs__msg__UpdateStatus(cdr, ros_message);
}
