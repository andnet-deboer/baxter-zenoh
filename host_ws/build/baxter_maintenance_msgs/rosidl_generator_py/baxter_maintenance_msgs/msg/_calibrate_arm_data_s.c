...
bool baxter_maintenance_msgs__msg__calibrate_arm_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_maintenance_msgs.msg._calibrate_arm_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("CalibrateArmData", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
