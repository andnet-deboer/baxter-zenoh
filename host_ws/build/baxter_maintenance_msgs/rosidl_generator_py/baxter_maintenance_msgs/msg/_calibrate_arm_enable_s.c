...
bool baxter_maintenance_msgs__msg__calibrate_arm_enable__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_maintenance_msgs.msg._calibrate_arm_enable", (char *)PyUnicode_1BYTE_DATA(module_attr), 49) == 0);
    assert(strncmp("CalibrateArmEnable", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
