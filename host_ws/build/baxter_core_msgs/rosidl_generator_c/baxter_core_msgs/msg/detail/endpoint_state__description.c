...
static char baxter_core_msgs__msg__EndpointState__FIELD_NAME__header[] = "header";
static char baxter_core_msgs__msg__EndpointState__FIELD_NAME__pose[] = "pose";
static char baxter_core_msgs__msg__EndpointState__FIELD_NAME__twist[] = "twist";
static char baxter_core_msgs__msg__EndpointState__FIELD_NAME__wrench[] = "wrench";

static rosidl_runtime_c__type_description__Field baxter_core_msgs__msg__EndpointState__FIELDS[] = {
  {
    {baxter_core_msgs__msg__EndpointState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {baxter_core_msgs__msg__EndpointState__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {baxter_core_msgs__msg__EndpointState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {baxter_core_msgs__msg__EndpointState__FIELD_NAME__wrench, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription baxter_core_msgs__msg__EndpointState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {baxter_core_msgs__msg__EndpointState__FIELDS, 4, 4},
    },
    {baxter_core_msgs__msg__EndpointState__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
baxter_core_msgs__msg__EndpointState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *baxter_core_msgs__msg__EndpointState__get_individual_type_description_source(NULL),
