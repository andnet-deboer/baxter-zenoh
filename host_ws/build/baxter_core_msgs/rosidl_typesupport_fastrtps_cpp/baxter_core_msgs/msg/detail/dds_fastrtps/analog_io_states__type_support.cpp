...
#include "baxter_core_msgs/msg/detail/analog_io_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const baxter_core_msgs::msg::AnalogIOState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  baxter_core_msgs::msg::AnalogIOState &);
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_AnalogIOState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const baxter_core_msgs::msg::AnalogIOStates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs::msg::AnalogIOStates & ros_message)
{
  // Member: names
  {
    cdr >> ros_message.names;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_baxter_core_msgs
max_serialized_size_AnalogIOStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        baxter_core_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AnalogIOState(
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs::msg::AnalogIOStates;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_baxter_core_msgs
max_serialized_size_key_AnalogIOStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        baxter_core_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_AnalogIOState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const baxter_core_msgs::msg::AnalogIOStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<baxter_core_msgs::msg::AnalogIOStates *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AnalogIOStates__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const baxter_core_msgs::msg::AnalogIOStates *>(
...
static size_t _AnalogIOStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AnalogIOStates(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AnalogIOStates__callbacks = {
...
static rosidl_message_type_support_t _AnalogIOStates__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AnalogIOStates__callbacks,
...
{
  return &baxter_core_msgs::msg::typesupport_fastrtps_cpp::_AnalogIOStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, baxter_core_msgs, msg, AnalogIOStates)() {
  return &baxter_core_msgs::msg::typesupport_fastrtps_cpp::_AnalogIOStates__handle;
}
