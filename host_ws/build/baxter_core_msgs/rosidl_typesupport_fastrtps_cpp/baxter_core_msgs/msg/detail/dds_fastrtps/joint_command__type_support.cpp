...
#include "baxter_core_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const baxter_core_msgs::msg::JointCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs::msg::JointCommand & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs::msg::JointCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const baxter_core_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<baxter_core_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  return &baxter_core_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, baxter_core_msgs, msg, JointCommand)() {
  return &baxter_core_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
