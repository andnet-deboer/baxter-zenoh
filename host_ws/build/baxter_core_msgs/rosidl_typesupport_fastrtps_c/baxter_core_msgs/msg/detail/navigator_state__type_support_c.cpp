  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs__msg__NavigatorState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_core_msgs__msg__NavigatorState * ros_message = static_cast<const baxter_core_msgs__msg__NavigatorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_core_msgs__msg__NavigatorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_core_msgs__msg__NavigatorState * ros_message = static_cast<baxter_core_msgs__msg__NavigatorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_core_msgs__msg__NavigatorState(cdr, ros_message);
}
