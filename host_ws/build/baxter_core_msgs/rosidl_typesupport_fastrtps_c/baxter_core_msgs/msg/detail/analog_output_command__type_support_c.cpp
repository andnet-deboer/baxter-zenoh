...
bool cdr_serialize_baxter_core_msgs__msg__AnalogOutputCommand(
  const baxter_core_msgs__msg__AnalogOutputCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_deserialize_baxter_core_msgs__msg__AnalogOutputCommand(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs__msg__AnalogOutputCommand * ros_message)
{
  // Field name: name
  {
    std::string tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs__msg__AnalogOutputCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_serialize_key_baxter_core_msgs__msg__AnalogOutputCommand(
  const baxter_core_msgs__msg__AnalogOutputCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t get_serialized_size_key_baxter_core_msgs__msg__AnalogOutputCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AnalogOutputCommand__ros_msg_type * ros_message = static_cast<const _AnalogOutputCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t max_serialized_size_key_baxter_core_msgs__msg__AnalogOutputCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_core_msgs__msg__AnalogOutputCommand * ros_message = static_cast<const baxter_core_msgs__msg__AnalogOutputCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_core_msgs__msg__AnalogOutputCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_core_msgs__msg__AnalogOutputCommand * ros_message = static_cast<baxter_core_msgs__msg__AnalogOutputCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_core_msgs__msg__AnalogOutputCommand(cdr, ros_message);
}
