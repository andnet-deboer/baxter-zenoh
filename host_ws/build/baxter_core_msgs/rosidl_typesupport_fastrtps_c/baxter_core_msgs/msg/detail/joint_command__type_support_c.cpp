...
#include "baxter_core_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
using _JointCommand__ros_msg_type = baxter_core_msgs__msg__JointCommand;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_serialize_baxter_core_msgs__msg__JointCommand(
  const baxter_core_msgs__msg__JointCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_deserialize_baxter_core_msgs__msg__JointCommand(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs__msg__JointCommand * ros_message)
{
  // Field name: mode
  {
    cdr >> ros_message->mode;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t get_serialized_size_baxter_core_msgs__msg__JointCommand(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t max_serialized_size_baxter_core_msgs__msg__JointCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs__msg__JointCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_serialize_key_baxter_core_msgs__msg__JointCommand(
  const baxter_core_msgs__msg__JointCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mode
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t get_serialized_size_key_baxter_core_msgs__msg__JointCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointCommand__ros_msg_type * ros_message = static_cast<const _JointCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t max_serialized_size_key_baxter_core_msgs__msg__JointCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_core_msgs__msg__JointCommand * ros_message = static_cast<const baxter_core_msgs__msg__JointCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_core_msgs__msg__JointCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_core_msgs__msg__JointCommand * ros_message = static_cast<baxter_core_msgs__msg__JointCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_core_msgs__msg__JointCommand(cdr, ros_message);
}

static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_baxter_core_msgs__msg__JointCommand(
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_baxter_core_msgs__msg__JointCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, baxter_core_msgs, msg, JointCommand)() {
