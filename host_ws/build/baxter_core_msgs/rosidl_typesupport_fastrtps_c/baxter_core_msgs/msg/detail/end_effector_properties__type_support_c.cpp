...
bool cdr_serialize_baxter_core_msgs__msg__EndEffectorProperties(
  const baxter_core_msgs__msg__EndEffectorProperties * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_deserialize_baxter_core_msgs__msg__EndEffectorProperties(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs__msg__EndEffectorProperties * ros_message)
{
  // Field name: id
  {
    cdr >> ros_message->id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs__msg__EndEffectorProperties;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_serialize_key_baxter_core_msgs__msg__EndEffectorProperties(
  const baxter_core_msgs__msg__EndEffectorProperties * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t get_serialized_size_key_baxter_core_msgs__msg__EndEffectorProperties(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EndEffectorProperties__ros_msg_type * ros_message = static_cast<const _EndEffectorProperties__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t max_serialized_size_key_baxter_core_msgs__msg__EndEffectorProperties(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_core_msgs__msg__EndEffectorProperties * ros_message = static_cast<const baxter_core_msgs__msg__EndEffectorProperties *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_core_msgs__msg__EndEffectorProperties(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_core_msgs__msg__EndEffectorProperties * ros_message = static_cast<baxter_core_msgs__msg__EndEffectorProperties *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_core_msgs__msg__EndEffectorProperties(cdr, ros_message);
}
