...
bool cdr_serialize_baxter_core_msgs__msg__EndpointState(
  const baxter_core_msgs__msg__EndpointState * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_baxter_core_msgs__msg__EndpointState(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs__msg__EndpointState * ros_message);
...
bool cdr_serialize_key_baxter_core_msgs__msg__EndpointState(
  const baxter_core_msgs__msg__EndpointState * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_baxter_core_msgs__msg__EndpointState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_baxter_core_msgs__msg__EndpointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_baxter_core_msgs__msg__EndpointStates(
  const baxter_core_msgs__msg__EndpointStates * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: names
  {
  ...
  // Field name: states
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_baxter_core_msgs__msg__EndpointState(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_deserialize_baxter_core_msgs__msg__EndpointStates(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs__msg__EndpointStates * ros_message)
{
  // Field name: names
  {
    uint32_t cdrSize;
  ...
  // Field name: states
  {
    ...
    auto array_ptr = ros_message->states.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_baxter_core_msgs__msg__EndpointState(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs__msg__EndpointStates;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_serialize_key_baxter_core_msgs__msg__EndpointStates(
  const baxter_core_msgs__msg__EndpointStates * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: names
  ...
  // Field name: states
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_baxter_core_msgs__msg__EndpointState(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t get_serialized_size_key_baxter_core_msgs__msg__EndpointStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EndpointStates__ros_msg_type * ros_message = static_cast<const _EndpointStates__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: states
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_baxter_core_msgs__msg__EndpointState(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t max_serialized_size_key_baxter_core_msgs__msg__EndpointStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_baxter_core_msgs__msg__EndpointState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_core_msgs__msg__EndpointStates * ros_message = static_cast<const baxter_core_msgs__msg__EndpointStates *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_core_msgs__msg__EndpointStates(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_core_msgs__msg__EndpointStates * ros_message = static_cast<baxter_core_msgs__msg__EndpointStates *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_core_msgs__msg__EndpointStates(cdr, ros_message);
}
