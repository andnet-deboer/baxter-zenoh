...
bool cdr_serialize_baxter_core_msgs__msg__RobustControllerStatus(
  const baxter_core_msgs__msg__RobustControllerStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_deserialize_baxter_core_msgs__msg__RobustControllerStatus(
  eprosima::fastcdr::Cdr & cdr,
  baxter_core_msgs__msg__RobustControllerStatus * ros_message)
{
  // Field name: is_enabled
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = baxter_core_msgs__msg__RobustControllerStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
bool cdr_serialize_key_baxter_core_msgs__msg__RobustControllerStatus(
  const baxter_core_msgs__msg__RobustControllerStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: is_enabled
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t get_serialized_size_key_baxter_core_msgs__msg__RobustControllerStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobustControllerStatus__ros_msg_type * ros_message = static_cast<const _RobustControllerStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_baxter_core_msgs
size_t max_serialized_size_key_baxter_core_msgs__msg__RobustControllerStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const baxter_core_msgs__msg__RobustControllerStatus * ros_message = static_cast<const baxter_core_msgs__msg__RobustControllerStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_baxter_core_msgs__msg__RobustControllerStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  baxter_core_msgs__msg__RobustControllerStatus * ros_message = static_cast<baxter_core_msgs__msg__RobustControllerStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_baxter_core_msgs__msg__RobustControllerStatus(cdr, ros_message);
}
