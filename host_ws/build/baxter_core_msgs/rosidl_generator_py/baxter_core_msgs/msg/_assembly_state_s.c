...
bool baxter_core_msgs__msg__assembly_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._assembly_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("AssemblyState", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
