...
bool baxter_core_msgs__msg__robust_controller_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._robust_controller_status", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("RobustControllerStatus", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
