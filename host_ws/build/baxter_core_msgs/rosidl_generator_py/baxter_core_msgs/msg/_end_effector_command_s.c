...
bool baxter_core_msgs__msg__end_effector_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._end_effector_command", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("EndEffectorCommand", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  baxter_core_msgs__msg__EndEffectorCommand * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of EndEffectorCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("baxter_core_msgs.msg._end_effector_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EndEffectorCommand");
