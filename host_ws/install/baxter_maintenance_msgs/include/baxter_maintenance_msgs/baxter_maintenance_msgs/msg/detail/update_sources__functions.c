...
baxter_maintenance_msgs__msg__UpdateSources__init(baxter_maintenance_msgs__msg__UpdateSources * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->uuid)) {
    baxter_maintenance_msgs__msg__UpdateSources__fini(msg);
    return false;
  }
  // sources
  if (!baxter_maintenance_msgs__msg__UpdateSource__Sequence__init(&msg->sources, 0)) {
    baxter_maintenance_msgs__msg__UpdateSources__fini(msg);
    return false;
  }
  return true;
...
baxter_maintenance_msgs__msg__UpdateSources__fini(baxter_maintenance_msgs__msg__UpdateSources * msg)
{
  ...
  // sources
  baxter_maintenance_msgs__msg__UpdateSource__Sequence__fini(&msg->sources);
}
...
baxter_maintenance_msgs__msg__UpdateSources__are_equal(const baxter_maintenance_msgs__msg__UpdateSources * lhs, const baxter_maintenance_msgs__msg__UpdateSources * rhs)
{
  ...
  // sources
  if (!baxter_maintenance_msgs__msg__UpdateSource__Sequence__are_equal(
  ...
  baxter_maintenance_msgs__msg__UpdateSources * output)
{
  ...
  // sources
  if (!baxter_maintenance_msgs__msg__UpdateSource__Sequence__copy(
...
baxter_maintenance_msgs__msg__UpdateSources__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  baxter_maintenance_msgs__msg__UpdateSources * msg = (baxter_maintenance_msgs__msg__UpdateSources *)allocator.allocate(sizeof(baxter_maintenance_msgs__msg__UpdateSources), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(baxter_maintenance_msgs__msg__UpdateSources));
  bool success = baxter_maintenance_msgs__msg__UpdateSources__init(msg);
  if (!success) {
...
baxter_maintenance_msgs__msg__UpdateSources__Sequence__init(baxter_maintenance_msgs__msg__UpdateSources__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  baxter_maintenance_msgs__msg__UpdateSources * data = NULL;

  if (size) {
    data = (baxter_maintenance_msgs__msg__UpdateSources *)allocator.zero_allocate(size, sizeof(baxter_maintenance_msgs__msg__UpdateSources), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = baxter_maintenance_msgs__msg__UpdateSources__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        baxter_maintenance_msgs__msg__UpdateSources__fini(&data[i - 1]);
      }
...
baxter_maintenance_msgs__msg__UpdateSources__Sequence__fini(baxter_maintenance_msgs__msg__UpdateSources__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      baxter_maintenance_msgs__msg__UpdateSources__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  baxter_maintenance_msgs__msg__UpdateSources__Sequence * array = (baxter_maintenance_msgs__msg__UpdateSources__Sequence *)allocator.allocate(sizeof(baxter_maintenance_msgs__msg__UpdateSources__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = baxter_maintenance_msgs__msg__UpdateSources__Sequence__init(array, size);
  if (!success) {
...
baxter_maintenance_msgs__msg__UpdateSources__Sequence__destroy(baxter_maintenance_msgs__msg__UpdateSources__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    baxter_maintenance_msgs__msg__UpdateSources__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
baxter_maintenance_msgs__msg__UpdateSources__Sequence__are_equal(const baxter_maintenance_msgs__msg__UpdateSources__Sequence * lhs, const baxter_maintenance_msgs__msg__UpdateSources__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!baxter_maintenance_msgs__msg__UpdateSources__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  baxter_maintenance_msgs__msg__UpdateSources__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(baxter_maintenance_msgs__msg__UpdateSources);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    baxter_maintenance_msgs__msg__UpdateSources * data =
      (baxter_maintenance_msgs__msg__UpdateSources *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!baxter_maintenance_msgs__msg__UpdateSources__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          baxter_maintenance_msgs__msg__UpdateSources__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!baxter_maintenance_msgs__msg__UpdateSources__copy(
