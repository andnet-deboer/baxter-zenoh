...
// IWYU pragma: private, include "baxter_core_msgs/msg/assembly_state.h"


#ifndef BAXTER_CORE_MSGS__MSG__DETAIL__ASSEMBLY_STATE__FUNCTIONS_H_
#define BAXTER_CORE_MSGS__MSG__DETAIL__ASSEMBLY_STATE__FUNCTIONS_H_
 ...
 * calls
 * baxter_core_msgs__msg__AssemblyState__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_baxter_core_msgs
baxter_core_msgs__msg__AssemblyState *
baxter_core_msgs__msg__AssemblyState__create(void);

/// Destroy msg/AssemblyState message.
/**
 * It calls
 * baxter_core_msgs__msg__AssemblyState__fini()
 ...
 * baxter_core_msgs__msg__AssemblyState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * baxter_core_msgs__msg__AssemblyState__Sequence__fini()
 * on the array,
...
#endif  // BAXTER_CORE_MSGS__MSG__DETAIL__ASSEMBLY_STATE__FUNCTIONS_H_
