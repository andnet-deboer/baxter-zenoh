...
#ifndef BAXTER_CORE_MSGS__MSG__DETAIL__URDF_CONFIGURATION__TYPE_SUPPORT_H_
#define BAXTER_CORE_MSGS__MSG__DETAIL__URDF_CONFIGURATION__TYPE_SUPPORT_H_
...
#endif  // BAXTER_CORE_MSGS__MSG__DETAIL__URDF_CONFIGURATION__TYPE_SUPPORT_H_
