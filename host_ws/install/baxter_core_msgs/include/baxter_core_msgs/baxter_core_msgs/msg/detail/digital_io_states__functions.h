...
// IWYU pragma: private, include "baxter_core_msgs/msg/digital_io_states.h"


#ifndef BAXTER_CORE_MSGS__MSG__DETAIL__DIGITAL_IO_STATES__FUNCTIONS_H_
#define BAXTER_CORE_MSGS__MSG__DETAIL__DIGITAL_IO_STATES__FUNCTIONS_H_
 ...
 * calls
 * baxter_core_msgs__msg__DigitalIOStates__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_baxter_core_msgs
baxter_core_msgs__msg__DigitalIOStates *
baxter_core_msgs__msg__DigitalIOStates__create(void);

/// Destroy msg/DigitalIOStates message.
/**
 * It calls
 * baxter_core_msgs__msg__DigitalIOStates__fini()
 ...
 * baxter_core_msgs__msg__DigitalIOStates__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * baxter_core_msgs__msg__DigitalIOStates__Sequence__fini()
 * on the array,
...
#endif  // BAXTER_CORE_MSGS__MSG__DETAIL__DIGITAL_IO_STATES__FUNCTIONS_H_
