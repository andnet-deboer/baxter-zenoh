...
{
  new (message_memory) baxter_core_msgs::msg::HeadState(_init);
}

void HeadState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<baxter_core_msgs::msg::HeadState *>(message_memory);
  typed_message->~HeadState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember HeadState_message_member_array[4] = {
  {
    "pan",  // name
    ...
    offsetof(baxter_core_msgs::msg::HeadState, pan),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(baxter_core_msgs::msg::HeadState, is_turning),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(baxter_core_msgs::msg::HeadState, is_nodding),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(baxter_core_msgs::msg::HeadState, is_pan_enabled),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HeadState_message_members = {
  ...
  4,  // number of fields
  sizeof(baxter_core_msgs::msg::HeadState),
...
{
  return &::baxter_core_msgs::msg::rosidl_typesupport_introspection_cpp::HeadState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, baxter_core_msgs, msg, HeadState)() {
  return &::baxter_core_msgs::msg::rosidl_typesupport_introspection_cpp::HeadState_message_type_support_handle;
}
