  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x0b, 0xa3, 0x37, 0x5c, 0x5c, 0xfb, 0x3b, 0x90,
      0x92, 0xa7, 0x0b, 0x4e, 0xac, 0x0d, 0xee, 0x82,
      0x0b, 0x77, 0x63, 0x58, 0xa9, 0xf1, 0x53, 0x6e,
      0xd7, 0x69, 0xfc, 0x4d, 0xec, 0xb2, 0xee, 0xdf,
    }};
  return &hash;
}
...
#ifndef NDEBUG
static const rosidl_type_hash_t baxter_core_msgs__msg__EndpointState__EXPECTED_HASH = {1, {
    0xb3, 0x75, 0xb7, 0x4f, 0x07, 0x81, 0x31, 0x09,
    0x41, 0xcc, 0x08, 0xe4, 0x8a, 0xc6, 0x74, 0xa8,
    0xd8, 0x5a, 0x6b, 0x23, 0xc1, 0x53, 0x3c, 0x59,
    0x7e, 0xed, 0x0e, 0x2d, 0xac, 0xe5, 0xd4, 0xd2,
  }};
...
static char baxter_core_msgs__msg__EndpointStates__TYPE_NAME[] = "baxter_core_msgs/msg/EndpointStates";
static char baxter_core_msgs__msg__EndpointState__TYPE_NAME[] = "baxter_core_msgs/msg/EndpointState";
...
static char baxter_core_msgs__msg__EndpointStates__FIELD_NAME__names[] = "names";
static char baxter_core_msgs__msg__EndpointStates__FIELD_NAME__states[] = "states";

static rosidl_runtime_c__type_description__Field baxter_core_msgs__msg__EndpointStates__FIELDS[] = {
  {
    {baxter_core_msgs__msg__EndpointStates__FIELD_NAME__names, 5, 5},
    {
  ...
  {
    {baxter_core_msgs__msg__EndpointStates__FIELD_NAME__states, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {baxter_core_msgs__msg__EndpointState__TYPE_NAME, 34, 34},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription baxter_core_msgs__msg__EndpointStates__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {baxter_core_msgs__msg__EndpointState__TYPE_NAME, 34, 34},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {baxter_core_msgs__msg__EndpointStates__TYPE_NAME, 35, 35},
      {baxter_core_msgs__msg__EndpointStates__FIELDS, 2, 2},
    },
    {baxter_core_msgs__msg__EndpointStates__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    assert(0 == memcmp(&baxter_core_msgs__msg__EndpointState__EXPECTED_HASH, baxter_core_msgs__msg__EndpointState__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = baxter_core_msgs__msg__EndpointState__get_type_description(NULL)->type_description.fields;
...
baxter_core_msgs__msg__EndpointStates__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *baxter_core_msgs__msg__EndpointStates__get_individual_type_description_source(NULL),
    sources[1] = *baxter_core_msgs__msg__EndpointState__get_individual_type_description_source(NULL);
