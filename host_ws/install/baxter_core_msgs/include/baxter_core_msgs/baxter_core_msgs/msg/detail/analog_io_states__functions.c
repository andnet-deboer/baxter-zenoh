...
baxter_core_msgs__msg__AnalogIOStates__init(baxter_core_msgs__msg__AnalogIOStates * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->names, 0)) {
    baxter_core_msgs__msg__AnalogIOStates__fini(msg);
    return false;
  }
  // states
  if (!baxter_core_msgs__msg__AnalogIOState__Sequence__init(&msg->states, 0)) {
    baxter_core_msgs__msg__AnalogIOStates__fini(msg);
    return false;
  }
  return true;
...
baxter_core_msgs__msg__AnalogIOStates__fini(baxter_core_msgs__msg__AnalogIOStates * msg)
{
  ...
  // states
  baxter_core_msgs__msg__AnalogIOState__Sequence__fini(&msg->states);
}
...
baxter_core_msgs__msg__AnalogIOStates__are_equal(const baxter_core_msgs__msg__AnalogIOStates * lhs, const baxter_core_msgs__msg__AnalogIOStates * rhs)
{
  ...
  // states
  if (!baxter_core_msgs__msg__AnalogIOState__Sequence__are_equal(
  ...
  baxter_core_msgs__msg__AnalogIOStates * output)
{
  ...
  // states
  if (!baxter_core_msgs__msg__AnalogIOState__Sequence__copy(
...
baxter_core_msgs__msg__AnalogIOStates__create(void)
{
  ...
  baxter_core_msgs__msg__AnalogIOStates * msg = (baxter_core_msgs__msg__AnalogIOStates *)allocator.allocate(sizeof(baxter_core_msgs__msg__AnalogIOStates), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(baxter_core_msgs__msg__AnalogIOStates));
  bool success = baxter_core_msgs__msg__AnalogIOStates__init(msg);
  if (!success) {
...
baxter_core_msgs__msg__AnalogIOStates__Sequence__init(baxter_core_msgs__msg__AnalogIOStates__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  baxter_core_msgs__msg__AnalogIOStates * data = NULL;

  if (size) {
    data = (baxter_core_msgs__msg__AnalogIOStates *)allocator.zero_allocate(size, sizeof(baxter_core_msgs__msg__AnalogIOStates), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = baxter_core_msgs__msg__AnalogIOStates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        baxter_core_msgs__msg__AnalogIOStates__fini(&data[i - 1]);
      }
...
baxter_core_msgs__msg__AnalogIOStates__Sequence__fini(baxter_core_msgs__msg__AnalogIOStates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      baxter_core_msgs__msg__AnalogIOStates__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  baxter_core_msgs__msg__AnalogIOStates__Sequence * array = (baxter_core_msgs__msg__AnalogIOStates__Sequence *)allocator.allocate(sizeof(baxter_core_msgs__msg__AnalogIOStates__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = baxter_core_msgs__msg__AnalogIOStates__Sequence__init(array, size);
  if (!success) {
...
baxter_core_msgs__msg__AnalogIOStates__Sequence__destroy(baxter_core_msgs__msg__AnalogIOStates__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    baxter_core_msgs__msg__AnalogIOStates__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
baxter_core_msgs__msg__AnalogIOStates__Sequence__are_equal(const baxter_core_msgs__msg__AnalogIOStates__Sequence * lhs, const baxter_core_msgs__msg__AnalogIOStates__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!baxter_core_msgs__msg__AnalogIOStates__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  baxter_core_msgs__msg__AnalogIOStates__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(baxter_core_msgs__msg__AnalogIOStates);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    baxter_core_msgs__msg__AnalogIOStates * data =
      (baxter_core_msgs__msg__AnalogIOStates *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!baxter_core_msgs__msg__AnalogIOStates__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          baxter_core_msgs__msg__AnalogIOStates__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!baxter_core_msgs__msg__AnalogIOStates__copy(
