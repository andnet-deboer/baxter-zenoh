...
bool baxter_core_msgs__msg__camera_settings__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._camera_settings", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("CameraSettings", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
