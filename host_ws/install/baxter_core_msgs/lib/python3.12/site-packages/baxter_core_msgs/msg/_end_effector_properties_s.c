...
bool baxter_core_msgs__msg__end_effector_properties__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._end_effector_properties", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("EndEffectorProperties", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
