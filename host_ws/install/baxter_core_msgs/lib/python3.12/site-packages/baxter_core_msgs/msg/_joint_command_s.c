...
bool baxter_core_msgs__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._joint_command", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("JointCommand", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  baxter_core_msgs__msg__JointCommand * ros_message = _ros_message;
  {  // mode
...
PyObject * baxter_core_msgs__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("baxter_core_msgs.msg._joint_command");
